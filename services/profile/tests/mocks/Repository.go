...
// CreateCandidate provides a mock function with given fields: ctx, tx, c
func (_m *Repository) CreateCandidate(ctx context.Context, tx *pg.Tx, c *models.Candidate) (*models.Candidate, error) {
	ret := _m.Called(ctx, tx, c)

	var r0 *models.Candidate
	if rf, ok := ret.Get(0).(func(context.Context, *pg.Tx, *models.Candidate) *models.Candidate); ok {
		r0 = rf(ctx, tx, c)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *pg.Tx, *models.Candidate) error); ok {
		r1 = rf(ctx, tx, c)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Repository) CreateUser(ctx context.Context, m *models.User) (*models.User, error) {
	ret := _m.Called(ctx, m)
...
func (_m *Repository) DeleteAcademicHistory(ctx context.Context, cid uint64, ahid uint64) error {
...
func (_m *Repository) DeleteJobHistory(ctx context.Context, cid uint64, jhid uint64) error {
...
func (_m *Repository) GetAllCandidates(ctx context.Context, f models.CandidateFilters) ([]*models.User, error) {
	ret := _m.Called(ctx, f)
...
func (_m *Repository) GetCandidateByID(ctx context.Context, id uint64) (*models.User, error) {
	ret := _m.Called(ctx, id)
...
// UpdateCandidate provides a mock function with given fields: ctx, tx, c
func (_m *Repository) UpdateCandidate(ctx context.Context, tx *pg.Tx, c *models.Candidate) (*models.Candidate, error) {
	ret := _m.Called(ctx, tx, c)
...
// UpdateUser provides a mock function with given fields: ctx, c
func (_m *Repository) UpdateUser(ctx context.Context, c *models.User) (*models.User, error) {
	ret := _m.Called(ctx, c)
