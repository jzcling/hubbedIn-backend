...
func (_m *Repository) GetAllCandidates(ctx context.Context) ([]*models.Candidate, error) {
	ret := _m.Called(ctx)
...
func (_m *Repository) GetAllCompanies(ctx context.Context) ([]*models.Company, error) {
	ret := _m.Called(ctx)
...
func (_m *Repository) GetAllCourses(ctx context.Context) ([]*models.Course, error) {
	ret := _m.Called(ctx)
...
func (_m *Repository) GetAllDepartments(ctx context.Context) ([]*models.Department, error) {
	ret := _m.Called(ctx)
...
func (_m *Repository) GetAllInstitutions(ctx context.Context) ([]*models.Institution, error) {
	ret := _m.Called(ctx)
...
func (_m *Repository) GetAllSkills(ctx context.Context) ([]*models.Skill, error) {
	ret := _m.Called(ctx)
