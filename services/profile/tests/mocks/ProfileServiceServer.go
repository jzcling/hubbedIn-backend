...
func (_m *ProfileServiceServer) GetUserByID(_a0 context.Context, _a1 *pb.GetUserByIDRequest) (*pb.User, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *pb.User
	if rf, ok := ret.Get(0).(func(context.Context, *pb.GetUserByIDRequest) *pb.User); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pb.User)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *pb.GetUserByIDRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
