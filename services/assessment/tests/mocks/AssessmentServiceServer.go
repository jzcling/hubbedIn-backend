...
// BulkCreateQuestion provides a mock function with given fields: _a0, _a1
func (_m *AssessmentServiceServer) BulkCreateQuestion(_a0 context.Context, _a1 *pb.BulkCreateQuestionRequest) (*pb.BulkCreateQuestionResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *pb.BulkCreateQuestionResponse
	if rf, ok := ret.Get(0).(func(context.Context, *pb.BulkCreateQuestionRequest) *pb.BulkCreateQuestionResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *pb.BulkCreateQuestionRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// GetAssessmentAttemptByID provides a mock function with given fields: _a0, _a1
func (_m *AssessmentServiceServer) GetAssessmentAttemptByID(_a0 context.Context, _a1 *pb.GetAssessmentAttemptByIDRequest) (*pb.AssessmentAttempt, error) {
	ret := _m.Called(_a0, _a1)
