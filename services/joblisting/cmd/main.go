...
import (
	...
	"in-backend/services/joblisting/database"
...
func main() {
	...
	var (
		...
		joblistingService       = transport.NewGRPCServer(endpoints, serverOptions, logger)
	...
	var g group.Group
	{
		...
		*/
		g.Add(func() error {
			...
			pb.RegisterJoblistingServiceServer(grpcServer, joblistingService)
